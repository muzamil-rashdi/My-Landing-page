...
import EditTenantsModal from "./components/EditTenantsModal";
...
const tenantRows = [
  [
    { label: "Tenant Name", placeholder: "Enter a name", type: "text", name: "Tenant_Name" },
    { label: "Unit", placeholder: "Select Unit", type: "select", name: "Unit", options: ["Unit A", "Unit B"] },
    { label: "Phone Number", placeholder: "Enter phone number", type: "phone", name: "Phone_Number" },
    { label: "Email", placeholder: "john@example.com", type: "email", name: "Email" },
    { is_sent:true}
  ],
  [
    { label: "Tenant Name", placeholder: "Enter a name", type: "text", name: "Tenant_Name" },
    { label: "Unit", placeholder: "Select Unit", type: "select", name: "Unit", options: ["Unit A", "Unit B", "Unit C"] },
    { label: "Phone Number", placeholder: "Enter phone number", type: "phone", name: "Phone_Number" },
    { label: "Email", placeholder: "jane@example.com", type: "email", name: "Email" },
    { is_sent:false}
  ],
    [
    { label: "Tenant Name", placeholder: "Enter a name", type: "text", name: "Tenant_Name" },
...
export default function App() {
  return (
   <EditTenantsModal rows={tenantRows}>
