       ...
       <h1 className="text-3xl md:text-6xl mt-2 md:mt-">
        Here’s How We Make Repairs Easy
         ...
         <div className="flex flex-col w-full h-full mt-20 gap-5 md:gap-2">
            ...
            <div className=" flex flex-col sm:flex-row w-full h-full gap-5 md:gap-2 md:h-[350px] h-auto">
                ...
                <div className="relative px-4 py-6 font-normal flex-1 bg-[#ECEEF2] rounded-xl flex flex-col">
                    <span
                                    className="text-[#595959] absolute top-1 left-3  select-none pointer-events-none"
                                    style={{
                                        fontSize: "150px", // width/height as text size
                                        lineHeight: "170px",
                                        opacity: 0.05,
            ...
            <div className="flex flex-col sm:flex-row w-full f-full gap-5 md:gap-2 md:h-[350px] h-auto">
